...
describe('Step', function () {
  ...
  describe('pop()', function () {
    ...
    it('should remove manual files', function () {
      ...
      const fileExists = this.exists(`${this.testDir}/manuals/templates/step1.md.tmpl`);
  ...
  describe('edit()', function () {
    ...
    it('should resolve addition conflicts when tagging a step', function () {
      ...
      const oldFileExists = this.exists(`${this.testDir}/manuals/templates/step1.md.tmpl`);
      expect(oldFileExists).to.be.truthy;

      const newFileExists = this.exists(`${this.testDir}/manuals/templates/step2.md.tmpl`);
